...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            if self.config.actor_rollout_ref.rollout.mode == "tool":
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with _timer("step", timing_raw):
                    ...
                    # Check if response_mask already exists in the batch, if not compute it
                ...
                # collect metrics
                if self.config.actor_rollout_ref.rollout.mode == "tool":
                    metrics.update(compute_tool_metrics(batch=batch, n=self.config.actor_rollout_ref.rollout.n))
