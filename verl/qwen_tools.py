...
# class DrawLine(BaseTool):
#     name = "draw_line"
#     description = "Draws lines on images to highlight relationships or measurements. " \
#                   "Supports solid lines or directional arrows."
...
#             'name': 'start_point',
#             'type': 'list',
#             'description': "The starting point coordinates [x, y] of the line.",
#             'required': True,
#         },
#         {
#             'name': 'end_point',
#             'type': 'list',
#             'description': "The ending point coordinates [x, y] of the line or arrow.",
#             'required': True,
#         },
#         {
#             'name': 'mode',
#             'type': 'str',
#             'description': "The line mode: 'line' (solid line) or 'arrow' (directional arrow).",
#             'required': True,
#         }
#     ]
...
#             # Check if image is RGB or grayscale and convert to BGR for OpenCV
#             if len(img_np.shape) == 3:
#                 img_np = cv2.cvtColor(img_np, cv2.COLOR_RGB2BGR)
            
#             # Set line properties
#             line_color = (0, 0, 255)  # BGR Red color
#             line_width = 3
            
#             if mode == 'line':
#                 # Draw solid line using cv2.line
#                 cv2.line(img_np, 
#                         tuple(start_point), 
#                         tuple(end_point), 
#                         line_color, 
...
#                 cv2.arrowedLine(img_np, 
#                                tuple(start_point), 
#                                tuple(end_point), 
#                                line_color, 
#                                line_width, 
#                                tipLength=0.1)  # tipLength controls arrow head size
                
#             else:
#                 return {
#                     "text": f"Invalid mode '{mode}'. Must be 'line' or 'arrow'.",
#                     "image": None
#                 }
            
#             # Convert back to RGB for PIL and create PIL image
#             if len(img_np.shape) == 3:
#                 img_np = cv2.cvtColor(img_np, cv2.COLOR_BGR2RGB)
#             result_image = Image.fromarray(img_np)
            
#             return {
#                 "text": f"Drew a {mode} on image {args['image_id']}.",
#                 "image": [result_image]
#             }
                
#         except KeyError as e:
#             return {
#                 "text": f"Failed to draw line on image {args['image_id']} due to error: Key error: {str(e)}. Please check the tool_call format.",
#                 "image": None
#             }
#         except Exception as e:
#             return {
#                 "text": f"Failed to draw line on image {args['image_id']} due to error: {str(e)}",
#                 "image": None
#             }
...
#     name = "draw_line"
#     description = "Draws lines on images to highlight relationships or measurements. " \
#                   "Supports horizontal/vertical dashed lines, solid lines, or directional arrows."
...
#             'name': 'mode',
#             'type': 'str',
#             'description': "The line mode: 'horizontal' (dashed horizontal line), 'vertical' (dashed vertical line), 'line' (solid line), or 'arrow' (directional arrow).",
#             'required': True,
#         },
#         {
#             'name': 'end_point',
#             'type': 'list',
#             'description': "The ending point coordinates [x, y] of the line or arrow. Required when mode is 'arrow' or 'line'.",
#             'required': False,
#         }
#     ]
...
#                 for i in range(0, img_width, dash_length + gap_length):
#                     end_x = min(i + dash_length, img_width)
#                     cv2.line(img_np, (i, y), (end_x, y), line_color, line_width-1)
...
#                 for i in range(0, img_height, dash_length + gap_length):
#                     end_y = min(i + dash_length, img_height)
#                     cv2.line(img_np, (x, i), (x, end_y), line_color, line_width-1)
                
#             elif mode == 'line':
#                 # Check if end_point is provided for line mode
#                 if 'end_point' not in args:
#                     return {
#                         "text": f"Failed to draw line: end_point is required for line mode.",
#                         "image": None
#                     }
...
#             elif mode == 'arrow':
#                 # Check if end_point is provided for arrow mode
#                 if 'end_point' not in args:
#                     return {
#                         "text": f"Failed to draw arrow: end_point is required for arrow mode.",
#                         "image": None
#                     }
...
#             else:
#                 return {
#                     "text": f"Invalid mode '{mode}'. Must be 'horizontal', 'vertical', 'line', or 'arrow'.",
#                     "image": None
#                 }
